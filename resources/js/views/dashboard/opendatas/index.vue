                    ...
                    <v-card>
                        ...
                        >
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn :to="'/admin/opendatas/edit/' + item.id" color="primary" small><v-icon
                                    small
                                    class="mr-2"
                                ...
                                <v-btn :to="'/admin/opendata/' + item.id + '/files'" color="primary" small><v-icon
                                    small
                                    class="mr-2"
...
export default {
    ...
    data: () => ({
        ...
        breadcrumb_items:
            [
                ...
                {text: 'Очиқ маълумот', to: '/admin/opendatas', exact: true},
            ],
    }),
    mounted() {
        this.initialize();
    ...
    methods: {
        initialize() {
            api.readOpenDatas().then((response) => {
        ...
        deleteItemConfirm() {
            api.deleteOpenData(this.editedItem.id).then(response => {
