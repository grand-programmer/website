<template>
    ...
    >
        ...
        <v-btn
            ...
            dark
            class="new_item"
            :to="'/admin/opendata/' + $route.params.opendata + '/files/create'"
        >
            Янги қўшиш
        </v-btn>
                    ...
                    <v-card>
                        ...
                        >
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn :to="'/admin/opendata/' + $route.params.opendata + '/files/edit/' + item.id" color="primary" small><v-icon
                                    small
                                    class="mr-2"
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            {text: 'Йил', sortable: true, value: 'year', align: 'start',width:'30%'},
            {text: 'Чорак', sortable: true, value: 'quarter', align: 'start',width:'30%'},
    ...
    methods: {
        initialize() {
            ...
            api.readOpenDataFiles(this.$route.params.opendata).then((response) => {
        ...
        deleteItemConfirm() {
            api.deleteOpenDataFile(this.$route.params.opendata, this.editedItem.id).then(response => {
