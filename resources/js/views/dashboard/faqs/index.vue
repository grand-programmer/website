                    ...
                    <v-card>
                        ...
                        >
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn :to="'/admin/faqs/edit/' + item.id" color="primary" small><v-icon
                                    small
                                    class="mr-2"
...
export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            {text: 'Савол', sortable: true, value: 'question', align: 'start',width:'30%'},
            {text: 'Сорт', value: 'sort', align: 'start'},
            {text: 'Актив', value: 'active', align: 'start'},
    ...
    methods: {
        ...
        deleteItemConfirm() {
            api.deleteFaq(this.editedItem.id).then(response => {
