                    ...
                    <v-card>
                        ...
                        >
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn :to="'/admin/footermenu/view/' + item.id" color="primary" small><v-icon
                                    small
                                    class="mr-2"
                                ...
                                <v-btn :to="'/admin/footermenu/edit/' + item.id" color="primary" small><v-icon
                                    small
                                    class="mr-2"
...
export default {
    ...
    methods: {
        initialize() {
            api.readFooterMenus(0).then((response) => {
