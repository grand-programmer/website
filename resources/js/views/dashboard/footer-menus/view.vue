                    ...
                    <v-card>
                        ...
                        >
                            ...
                            <template v-slot:item.actions="{ item }">
                                <v-btn :to="'/admin/footermenu/view/' + item.id" color="primary" small>
                                    <v-icon
                                        small
                                        class="mr-2"
                                ...
                                <v-btn :to="'/admin/footermenu/edit/' + item.id" color="primary" small>
                                    <v-icon
                                        small
                                        class="mr-2"
...
export default {
    ...
    data: () => ({
        ...
        breadcrumb_items:
            [
                ...
                {text: 'Меню', to: '/admin/footermenu', exact: true},
            ],
    }),
    mounted() {
        this.initialize();
    ...
    methods: {
        initialize() {
            api.readFooterMenus(this.$route.params.id).then((response) => {
...
/*                if (field.to === '/admin/footermenu/view/' + menu.id) {
                ...
                if (exists) {
                    const index = this.breadcrumb_items.map(e => e.to).indexOf('/admin/footermenu/view/' + menu.id);
console.log(index)
                    ...
                    this.breadcrumb_items.push({
                        ...
                        to: '/admin/footermenu/view/' + this.menu.id,
                        exact: true
                    })
                }
            }).catch((error) => {
        ...
        deleteItemConfirm() {
            api.deleteFooterMenu(this.editedItem.id).then(response => {
