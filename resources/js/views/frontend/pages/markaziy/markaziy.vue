                                    ...
                                    <div class="left-bar">
                                        <div class="rahbar-items">
                                            ...
                                            ><p>
                                                ...
                                                <template v-else-if="rahbar.lavozimi==='2'">{{$t("Иқтисодиёт ва молия вазирлиги ҳузуридаги Божхона қўмитаси раисининг биринчи ўринбосари")}}</template>
                                                <template v-else>{{ $t("Иқтисодиёт ва молия вазирлиги ҳузуридаги Божхона қўмитаси раисининг ўринбосари") }}</template>
                                                                ...
                                                                <div>
                                                                    <div class="my-card-header">
                                                                        ...
                                                                        <div class="my-card-header-wrapper">
                                                                            <div class="profile-icon-wrapper" :style="[12,22].includes(boshqarma.id) ? 'border: none !important' : ''">
                                                                    ...
                                                                    <div class="my-card-info">
                                                                        ...
                                                                        <div class="text-row">
                                                                            <v-icon color="black" class="mr-3" style="margin-left:-5px">mdi-arrow-right</v-icon>
                                                                            <div class="column-text">
                                                                                <v-dialog max-width="900" scrollable>
                                                                                    <template v-slot:activator="{ on, attrs }">
                                                                                        <p class="text-decoration-underline" v-bind="attrs"
                                                                                           v-on="on"
                                                                                        >{{ $t("Бошқарма вазифалари") }}</p>
                                                                                    </template>
...
export default {
    ...
    methods: {
        ...
        async initialize() {
            ...
            const _this = this;
            await api.readMarkaziy(0).then((response) => {
