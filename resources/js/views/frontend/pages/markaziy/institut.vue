                ...
                <div class="col col-12">
                    <div class="single_blog_content">
                        <div class="widget_tittle">
                            <h3 class="w-100">{{ $t("Божхона институти тузилмаси") }}</h3>
                        </div>
                        <div>
                            <div class="container-fluid">
                                <div class="row">
...
export default {
    ...
    data() {
        return {
            breadcrumb_items: [
                ...
                {
                    text: i18n.t('Божхона институти'),
                    to: '/page/bozhhona-instituti-2',
                    disabled: false,
                    exact: true,
                },
                {
                    text: i18n.t('Божхона институти тузилмаси'),
    ...
    methods: {
        ...
        async initialize() {
            ...
            const _this = this;
            await api.readMarkaziy(1).then((response) => {
