<template>
    <router-view v-if="$route.path.indexOf('services/vio/')!== -1 ">
                        ...
                        <v-col cols="8">
                            <div class="d-flex my-5  align-items-center">
                                ...
                                <div class="d-flex flex-column justify-content-between ml-5">
                                    <h3 class="mb-2">{{ $t('Ваколатли иқтисодий оператори') }}</h3>
                                    <p class="mb-2"> {{ $t('Соддалаштирилган божхона тартиб-таомиллари ва божхона имтиёзлари қўлланиладиган, қонунга итоаткор ТИФ субъектларининг энг юқори синфи') }}</p>
                                </div>
                            </div>
                        </v-col>
                        <v-col cols="3" offset="1">
                            <v-btn large color="primary" class="my-5 " style=" width: 100%" @click="$auth.check()?$router.push('/services/vio/create'): ( $toast.warning($t('Авторизациядан ўтиш талаб этилади')) )">
    ...
    data() {
        return {
            breadcrumb_items: [
                ...
                {
                    text: i18n.t('Ваколатли иқтисодий оператори'),
                    to: '/services/vio',
                    disabled: true,
                    exact: true,
                },
            ...
            panels: [
                ...
                },
                {
                    ...
                    content: ['<a href="https://lex.uz/uz/docs/4966537">' + i18n.t('Ваколатли иқтисодий операторлар тўғрисидаги низомни тасдиқлаш ҳақида') + '</a>']
                },
                {
