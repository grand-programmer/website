    ...
    <div class="section customs-value-section">
        ...
        <div class="page-content" v-if="app">
            <v-container class="pb-6">
                <v-row>
                    <h3 class="pb-5"><b>Ариза рақами: </b>{{ app.appNum?app.appNum:null }}</h3>
                    <br>
                </v-row>
                <v-row class="pb-10">
                    <v-tabs
                                    ...
                                    <v-expansion-panel-content>
                                            ...
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold" >Корхона рахбари</h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-if="typeof app.s10CompanyPersons !== 'undefined' && korxonaRahbari && korxonaRahbari[0]" >
                                                    <td style="font-weight: 550">Ф.И.О</td>
                                                    <td>{{
                                                ...
                                                <tr v-if="typeof app.s10CompanyPersons !== 'undefined' && korxonaRahbari && korxonaRahbari[0]" >
                                                    <td style="font-weight: 550">ID-карта (паспорт) маълумотлари</td>
                                                    <td>{{
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && korxonaRahbari && korxonaRahbari[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Юридик шахс СТИРи, номи ва манзили</h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-if="typeof app.legalName !== 'undefined'" >
                                                    <td style="font-weight: 550">Ташкилот номи</td>
                                                    <td>{{
                                                            app.legalName
                                                        }}
                                                    </td>
                                                ...
                                                <tr v-if="typeof app.tin !== 'undefined'" >
                                                    <td style="font-weight: 550">Ташкилот СТИРИ</td>
                                                    <td>{{
                                                            app.tin
                                                        }}
                                                    </td>
                                                ...
                                                <tr v-if="typeof app.address !== 'undefined'" >
                                                    <td style="font-weight: 550">Ташкилот манзили</td>
                                                    <td>{{
                                                            app.address
                                                        }}
                                                    </td>
                                                ...
                                                <tr v-if="typeof app.vioType !== 'undefined'" >
                                                    <td style="font-weight: 550">Ариза тури</td>
                                                    <td>{{
                                                            app.vioType
                                                        }}
                                                    </td>
                                                ...
                                                <tr v-if="typeof app.lineOfWork !== 'undefined'" >
                                                    <td style="font-weight: 550">Ариза йўналиши</td>
                                                    <td>{{
                                                            app.lineOfWork
                                                        }}
                                                    </td>
                                                ...
                                                <tr v-if="typeof app.workAbout !== 'undefined'" >
                                                    <td style="font-weight: 550">Фаолият ҳақида</td>
                                                    <td>{{
                                                            app.workAbout
                                                        }}
                                                    </td>
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && tasischilar && tasischilar[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Корхона таъсисчилари </h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="tasischiItem in tasischilar" >
                                                    <td style="font-weight: 550">{{tasischilar.indexOf(tasischiItem) + 1}} - таъсисчи</td>
                                    ...
                                    <v-expansion-panel-content>
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && korxonaBuxgalter && korxonaBuxgalter[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold" >Корхона бухгалтери</h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && vakolatlishaxslar && vakolatlishaxslar[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Ваколатли шахслар </h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="vakolatliItem in vakolatlishaxslar" >
                                                    <td style="font-weight: 550">{{vakolatlishaxslar.indexOf(vakolatliItem) + 1}} - ваколатли шахс</td>
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && brokerlar && brokerlar[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Брокерлар </h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="brokerItem in brokerlar" >
                                                    <td style="font-weight: 550">{{brokerlar.indexOf(brokerItem) + 1}} - брокер</td>
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && shippings && shippings[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Бир турдаги етказиб берувчилар </h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="shippingItem in shippings" >
                                                    <td style="font-weight: 550">{{shippings.indexOf(shippingItem) + 1}} - етказиб бурувчи</td>
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10CompanyPersons !== 'undefined' && owners && owners[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Эгалик ҳуқуқи асосида иншоотлар, бинолар ва очиқ майдончалар</h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="ownerItem in owners" >
                                                    <td style="font-weight: 550">{{owners.indexOf(ownerItem) + 1}} - бино, иншоот ва майдонча</td>
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10Earxivs !== 'undefined' && flats && flats[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Ижара ҳуқуқи асосида иншоотлар, бинолар ва очиқ майдончалар</h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="ownerItem in flats" >
                                                    <td style="font-weight: 550">{{flats.indexOf(ownerItem) + 1}} - бино, иншоот ва майдонча</td>
                                        ...
                                        <v-simple-table v-if="app && typeof app.s10Earxivs !== 'undefined' && courses && courses[0]">
                                            <template v-slot:default>
                                                ...
                                                <tr>
                                                    <th class="text-left" style="font-weight: 550">
                                                        <h4  class="py-4 font-weight-bold">Сертификатлари</h4>
                                                    </th>
                                                    <th class="text-left" style="font-weight: 550">
                                                ...
                                                <tr v-for="ownerItem in courses" >
                                                    <td style="font-weight: 550">{{flats.indexOf(ownerItem) + 1}} - сертификат</td>
                                                    <td>{{ ownerItem.contractNumber }} ({{ ownerItem.cadastralNumber }}) / ({{ ownerItem.depotAddress }})</td>
                                                </tr>
                                                </tbody>
                                            </template>
                                    ...
                                    >
                                        <v-row justify="start">
                                            <v-col cols="10">
                                                ...
                                                <p v-if="1===2 && appstatus.status==='600'" style="font-size: 15px"> <a :href="'https://qaror.customs.uz/s09decisionPdfDownloadAppeal?stId=' + appstatus.id"> Рухсатномани юклаб олинг! </a></p>
                                                <p v-if="1===2 && appstatus.status==='201' || appstatus.status==='600'" style="font-size: 15px"> <a :href="'https://qaror.customs.uz/s09decisionPdfDownloadAppeal?stId=' + appstatus.id"> Аризангиз жавоб хатини юклаб олинг! </a></p>
<br>
