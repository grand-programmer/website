    ...
    data() {
        return {
            ...
            fields: [
                ...
                {key: 'personName', value: (typeof this.person!=='undefined' && typeof this.person.type!=='undefined' && this.person.type===2)?'Ташкилот номи':'ФИШ'},
        ...
        async sendApplication() {
            ...
            try {
                ...
                if(typeof error.response !=='undefined' && typeof error.response.data !=='undefined' && typeof error.response.data.data !=='undefined' && typeof error.response.data.data.errors !=='undefined'){
                    if(typeof error.response.data.data.errors.appsBody !=='undefined') _this.setApplicationErrors(error.response.data.data.errors.appsBody);
