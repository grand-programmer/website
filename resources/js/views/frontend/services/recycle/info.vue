          ...
          <v-tabs-items v-model="tab" class="fixed-color-tabs">
            ...
            >
              ...
              <v-expansion-panels v-model="panel">
                ...
                >
                  <v-expansion-panel-header>
                    {{ $t('Товарлар тўғрисида маълумотлар') }}
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <template v-for="(product,key) in app.s03Commodities">
                      <v-col><h5 style="font-weight: bold">{{ key + 1 }} {{ $t('- товар номи') }}
                      ...
                      <v-simple-table>
                        <template v-slot:default>
                          ...
                          <tr v-if="typeof product.cmdtNm !=='undefined'">
                            <td style="font-weight: 550">{{ $t('Товар номи') }}</td>
                            <td>{{
                          ...
                          <tr v-if="typeof product.cmdtNetto !=='undefined'">
                            <td style="font-weight: 550">{{ $t('Асосий ўлчов бирлигидаги миқдори') }}
                            </td>
                            <td>{{
                          ...
                          <tr v-if="typeof product.cmdtQty !=='undefined'">
                            <td style="font-weight: 550">{{ $t('Қўшимча ўлчов бирлигидаги миқдори') }}
                            </td>
                            <td>{{
                          ...
                          <tr v-if="typeof product.cmdtCost !=='undefined'">
                            <td style="font-weight: 550">{{ $t('Товар қиймати') }}</td>
                            <td>{{
                          ...
                          <tr v-if="typeof product.cmdtStatusNm !=='undefined'">
                            <td style="font-weight: 550">{{ $t('Товар мақоми') }}</td>
                            <td>{{
                          ...
                          <tr v-if="typeof product.cmdtStatus !=='undefined' && product.cmdtStatus ==='3' && product.s03CommodityDops.length>0">
                            <td style="font-weight: 550">{{ $t('Қайта ишлаш махсулотларининг чиқиш нормаси') }}
                            </td>
                            <td>
                              ...
                              <v-list nav dense >
                                <v-list-item-group v-model="headerHighlight" color="primary">
                                  <v-list-item >
                                    <v-list-item-content>{{ $t('Товар номи') }}
                                    </v-list-item-content>
                                    <v-list-item-content>{{ $t('Товар миқдори') }}
                                    </v-list-item-content>
                                  </v-list-item>
                                  <v-list-item
...
export default {
  ...
  methods: {
    ...
    getAppData() {
      ...
      setTimeout(() => {
        this.$store.commit('setLoading', true)
        this.$auth.plugins.http.get("/api/v1/ex_api/recycle-get", {
          params: {
