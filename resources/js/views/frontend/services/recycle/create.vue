            ...
            <v-stepper-content step="1">
              ...
              >
                <div class="row position-absolute yoriqnoma-text"><a
                    href="/storage/files/Pererabotka.pptx"> {{ $t('Ариза тўлдириш бўйича йўриқмани юклаб олинг!') }}
                </a></div>
                    ...
                    <v-col cols="6">
                      <ValidationProvider :name="$t('Манзили')" rules="required"
                        ...
                        <v-text-field
                            ...
                            :counter="200"
                            required
                            :hint="$t(person.type==1?'Аризачининг манзили':'Юридик шахснинг манзили')"
                            persistent-placeholder
                        >
                    ...
                    <v-row class="align-end">
                      ...
                      <v-container class="w-100 m-0 p-4" fluid>
                        <v-row>
                          ...
                          <v-col cols="4">
                            <ValidationProvider
                              ...
                              <v-autocomplete
                                  ...
                                  :label="$t('Қайта ишловчи СТИРи*')"
                                  required
                                  :hint="$t('Қайта ишловчи СТИРи')"
                                  persistent-placeholder
                                  :items="recycle_orgs"
                                  item-text="shortname"
                                  item-value="tin"
                          ...
                          <v-col cols="8">
                            <ValidationProvider
                                :name="$t('Шартнома идентификация рақами')"
                                rules="required"
                                v-slot="{ errors }">
                              <v-autocomplete
                                  v-model="application.contract"
                                  :label="$t('Шартнома идентификация рақами*')"
                                  required
                                  persistent-placeholder
                                  :items="contracts"
                                  item-text="kntid"
                          ...
                          <v-col cols="9" class="position-relative">
                            <e-arxiv-file
                                ...
                                :hint="$t('Шартнома, техник иқтисодий асос, чиқиш нормаси, идентификация усули')"
                            ></e-arxiv-file>
                      ...
                      <v-tabs-items
                        ...
                        >
                          <ValidationObserver v-slot="{ invalid }"
                            ...
                            <v-row>
                              <v-col cols="6">
                                <ValidationProvider :name="$t('Мақоми')"
                                                    v-slot="{ errors }">
                                  <v-autocomplete
                              ...
                              <v-col cols="6">
                                <ValidationProvider
                                    :name="$t('Товар қиймати')"
                                    v-slot="{ errors }">
                                  <v-text-field
                                      :label="$t('Товар қиймати *')"
                                      persistent-placeholder
                                      name="tasnifi"
                                      :hint="$t('Қиймати')"
                              ...
                              <v-col cols="3">
                                <ValidationProvider
                                  ...
                                  >
                                    <template v-slot:append>
                                      <span class="append-slot">{{ $t('кг') }}</span>
                                    </template>
                              ...
                              <div style="border: 1px dashed ; padding:10px;"
                                ...
                                <h4>{{ $t('Қайта ишлаш махсулотларининг чиқиш нормаси') }}</h4>
                                <v-col cols="3"
                                       v-if="(typeof application.tovarlar[key].status !=='undefined' && application.tovarlar[key].status===3)">
                                  <autocomplete-field
                                      :title="$t('Шартли бирлик')"
                                ...
                                <v-col cols="12">
                                  <v-row>
                                    ...
                                    <v-col cols="1">
                                      <v-btn color="primary" class="new"
                                             @click="addSubProduct(key)">{{ $t('Қўшиш') }}
                                      </v-btn>
                                    </v-col>
                                  </v-row>
                                  <v-row
                  ...
                  >
                    <template v-slot:activator="{ on, attrs }">
                      <v-btn text
                             v-bind="attrs"
                             v-on="on"
                      >{{ $t('Киритилган товарлар -') }} <span style="color: var(--mycolor)">{{application.tovarlar.length}}</span>
                      </v-btn>
                    ...
                    <v-card>
                      <v-toolbar
                          color="primary"><span
                          style="color: #fff; font-size: 18px;text-align: center;"> {{ $t('Киритилган товарлар рўйхати мақомлар кесимида') }} </span>
                      </v-toolbar>
                            ...
                            <v-card flat>
                              ...
                              <v-card-text v-else>
                                <v-row
                                  ...
                                  {{ $t('Бу мақомдаги товарлар киритилмади') }}
                                </v-row>
                              </v-card-text>
                            </v-card>
                          </v-tab-item>
...
export default {
  ...
  data() {
    return {
      ...
      maqomlar: [
        {text: typeof this.application!=='undefined' && this.application.rejim===200?i18n.t("Олиб чиқиладиган товарлар"):i18n.t("Олиб кириладиган товарлар"), value: 1},
        {text: typeof this.application!=='undefined' && this.application.rejim===200?i18n.t("Ишлатиладиган чет эл товари"):i18n.t("Ўзбекистон товари"), value: 2},
      ...
      tab: 0,
      headers: [
        {text: i18n.t('ТИФ ТН'), align: 'start', value: 'tftn.id'},
        {text: i18n.t('Товар номи'), align: 'start', value: 'nomlanishi'},
        {text: i18n.t('Товар миқдори'), align: 'start', value: 'weight'},
      ],
      subHeaders: [
        {text: i18n.t('Товар номи'), align: 'start', value: 'nomlanishi'},
        {text: i18n.t('Товар миқдори'), align: 'start', value: 'miqdor'},
        {text: i18n.t('Операция'), align: 'start', value: 'actions'},
      ],
      contracts: [],
      subProduct: {
        hsCode: null,
        ...
        case 1:
          ...
          setTimeout(async () => {
            ...
            if (isValid === true) {
              ...
              } else this.$toast.error(i18n.t("Маълумотлар киритишда хатолик юз берди. Қайта уриниб кўринг!"));
        ...
        case 3:
          ...
          setTimeout(async () => {
            ...
            if (typeof resultData !== 'undefined' && typeof resultData.data !== 'undefined' && typeof resultData.data.success !== 'undefined' && resultData.data.success === true) {
              ...
              this.$cookie.delete('user');
              this.$toast.success(i18n.t("Сизнинг аризангиз омадли тарзда юборилди!"));
              setTimeout(() => {
