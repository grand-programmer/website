                ...
                <v-row>
                    <v-col cols="12">
                        <h3 align="center" class="lh-sm font-weight-bold primary-color">
                            Товарни божхона ҳудудида қайта ишлаш учун рухсатнома бериш тўғрисида ариза
                            <br>
                        </h3>
                    </v-col>
                </v-row>
                                    ...
                                    <ValidationObserver v-slot="{ invalid }"
                                        ...
                                        <v-row class="align-end">
                                            ...
                                            <v-container class="w-100 m-0 p-4">
                                                <v-row>
                                                    <v-col cols="4">
                                                        <ValidationProvider name="Шартноманинг идентификатция рақами"
                                                                            rules="required"
                                                                            v-slot="{ errors }">
                                                            <v-text-field
                                                                label="Шартноманинг идентификатция рақами *"
                                                                required
                                                                hint="Шартноманинг идентификатция рақами"
                                                                persistent-placeholder
                                                    ...
                                                    <v-col cols="4">
                                                        <ValidationProvider name="Идентификатция усули"
                                                                            rules="required"
                                                                            v-slot="{ errors }">
                                                            <v-text-field
                                                                label="Идентификатция усули *"
                                                                required
                                                                hint="Идентификатция усули"
                                                                persistent-placeholder
                                                    ...
                                                    <v-col cols="4">
                                                        <ValidationProvider name="Қайта ишлаш оператцияларининг қиймати"
                                                                            rules="required"
                                                                            v-slot="{ errors }">
                                                            <v-text-field
                                                                label="Қайта ишлаш оператцияларининг қиймати *"
                                                                required
                                                                hint="Қайта ишлаш оператцияларининг қиймати"
                                                                persistent-placeholder
                                                    ...
                                                    <v-col cols="4">
                                                        <ValidationProvider
                                                            name="Қайта ишловчи номи"
                                                            rules="required"
                                                            v-slot="{ errors }">
                                                            <v-text-field
                                                                label="Қайта ишловчи номи *"
                                                                required
                                                                hint="Қайта ишловчи номи"
                                                                persistent-placeholder
