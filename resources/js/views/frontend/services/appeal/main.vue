...
<!--                        <v-list-item :to="{path:'appeals/create', query: { type: 0 }}">-->
                        <v-list-item>
                            ...
                            <v-card-text align="center">
                                ...
                                <v-form>
                                    <div class="form-field"><label>Мурожаат рақами </label><v-text-field v-model="submit_appeal.appeal_id">
                                </v-text-field></div>
                                    <div class="form-field">
                                        <label>Текшириш коди</label> <v-text-field v-model="submit_appeal.appeal_code">
                                    </v-text-field></div>
                                    <v-btn color="primary">
                                        Текшириш
                                    </v-btn>
