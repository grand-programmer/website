                    ...
                    <v-stepper-items>
                                        ...
                                        <div class="price-block">
                                            ...
                                            <v-row>
                                                <v-col cols="6">
                                                    ...
                                                    <p>- 300 та қаторгача (товар) - БҲМ 10%;</p>
                                                    <p>- 700 та қаторгача (товар) - БҲМ 20%;</p>
                                                    <p>- 1500 та қаторгача (товар) - БҲМ 50%;</p>
                                                </v-col>
                                                <v-col cols="6">
                                                    <p>- 5 000 та қаторгача (товар) - 1 БҲМ;</p>
                                                    <p>- 15 000 та қаторгача (товар) - 2 БҲМ;</p>
                                                    <p>- 15001 тадан ортиқ қаторгача (товар) - 3 БҲМ;</p>
                                                    <p>- Қўшимча хар бир графа учун - хизмат тарифининг 5%.</p>
                                                </v-col>
                                            </v-row>
                                        </div>
                                    </v-col>
                        ...
                        <v-stepper-content step="4">
                            ...
                            >
                                ...
                                <v-row>
                                    <h5 class="mb-6">{{
                                            (application.serviceType===0) ? $t('Қўшимча қайси илова ҳужжатларидан нусха олишни хохлайсиз?'): $t('Қўшимча қайси графаларни юклаб олишни хохлайсиз?')
                                        }}</h5>
                                    ...
                                    >
                                        ...
                                        >
                                            <v-list-item v-for="(additionField, additionFieldKey) in additions"
                                                         style="flex-basis: 50%">
                                                <template v-slot:default="{ active }">
...
export default {
    ...
    methods: {
        ...
        async getStatServices() {
            ...
            await axios.get('/api/v1/statservice', {params: {status: 0}}).then(async res => {
                if (res.status === 200) {
    ...
    computed: {
        completedData(){
            return  [
                ...
                {label: 'Хизмат тури', value: (this.application.serviceType!==null)?this.serviceTypes[this.application.serviceType].title : '' },
                {label: 'Ҳудудий божхона бошқармаси', value: (this.application.region!==null)?this.findElementInlist(this.list.regions,this.application.region,'value').title:''},
                {label: 'Пост', value: (this.application.post!==null)?this.findElementInlist(this.list.posts,this.application.post,'value').title:''},
                {label: 'Божхона режими', value: (this.application.rejim!==null)?this.findElementInlist(this.list.regimes,this.application.rejim,'value').title:''},
                ...
                {label: 'Давлат', value: (this.application.country!==null)?this.findElementInlist(this.list.countries,this.application.country,'value').title:''},
        ...
        additions(){
            if(this.application.serviceType === 0) return this.additionFields
            else return this.additionalFields2
        }
    }
    ,
    filters: {
