...
<span style="height: 20px">  </span>
                                        <template v-for="tovar in app.s01Commodities"  v-if="app.s01Commodities">
...
export default {
    ...
    methods: {
        ...
        getAppData() {
            ...
            setTimeout(() => {
                this.$store.commit('setLoading', true)
                this.$auth.plugins.http.get("/api/v1/ex_api/intellektual-get", {
                    params: {
