                                                ...
                                                <v-row>
                                                    <v-col cols="12" class="row"
                                                        ...
                                                        <dialog-chips
                                                            ...
                                                            :error="ishchiqErrors" :total_error="ishchiqTotalErrors" ></dialog-chips>
                                                    ...
                                                    <ValidationObserver v-slot="{ invalid }"
                                                        ...
                                                        <v-row>
                                                            ...
                                                            <v-col cols="9" class="position-relative">
                                                                <e-arxiv-file v-model="documents"
                                                                              multiple
    ...
    data() {
        return {
            ...
            klassifikatorlar: [
                ...
                {
                    value: '24',
                    label: '24-Tўқимачилик ва унинг ўрнини босувчи маҳсулотлар;',
                    text: 'Tўқимачилик ва унинг ўрнини босувчи маҳсулотлар;'
                },
                {value: '25', label: '25-маиший фойдаланиш учун чойшаблар;', text: 'маиший фойдаланиш учун чойшаблар;'},
                {
                    value: '26',
                    label: '26-тўқимачилик ва пластмасса материаллардан тайёрланган пардалар',
                    text: 'тўқимачилик ва пластмасса материаллардан тайёрланган пардалар'
                },
                {value: '27', label: '27-Кийим, пойабзал, бош кийимлар.', text: 'Кийим, пойабзал, бош кийимлар.'},
                {
                    value: '28',
                    label: '28-Дантел ва кашталар, ортиқча оро бермай ва ленталар; тугмалар, тугмалар, илгаклар ва блоклар, игналар ва игналар; сунъий гуллар; соч безаклари; сунъий сочлар',
                ...
                {
                    value: '29',
                    label: '29-Гиламлар,гиламларчалар, линолеум ва бошқа пол қопламалари; девор қоғози ва қоплама материаллари (тўқимачилик бўлмаган).',
                    text: 'Гиламлар,гиламларчалар, линолеум ва бошқа пол қопламалари; девор қоғози ва қоплама материаллари (тўқимачилик бўлмаган).'
                },
                {
                    value: '30',
                    label: '30-Ўйинлар, ўйинчоқлар; видео ўйинлар учун қурилмалар; гимнастика ва спорт буюмлари; Рождество безаклари',
                    text: 'Ўйинлар, ўйинчоқлар; видео ўйинлар учун қурилмалар; гимнастика ва спорт буюмлари; Рождество безаклари'
                },
                {
                    value: '31',
                    label: '31-Гўшт, балиқ, парранда ва ов; гўшт экстракти; консерваланган, қуритилган ва иссиқлик билан ишлов берилган сабзавотлар ва мевалар; желе, мураббо, компотлар; тухум; сут ва сут маҳсулотлари; истеъмол қилинадиган ёғлар ва ёғлар.',
                ...
                {
                    value: '32',
                    label: '32-Қаҳва, чой, какао ва кофе ўрнини босувчи маҳсулотлар; гуруч; тапиока (маниока) ва саго; ун ва дон маҳсулотлари;нон маҳсулотлари, қандолат маҳсулотлари; музқаймоқ; шакар, асал, мелас сиропи; хамиртуруш, пишириш кукунлари; туз; хантал; сирка, зираворлар; зираворлар; совутиш учун муз',
                ...
                {
                    value: '33',
                    label: '33-Қишлоқ, сув хўжалиги, боғдорчилик ва ўрмон хўжалиги маҳсулотлари, қайта ишланмаган ва қайта ишланмаган; қайта ишланган ёки қайта ишланмаган дон ва уруғлар; янги мевалар, сабзавотлар ва хушбўй ўтлар; тирик ўсимликлар ва гуллар; лампочкалар, кўчатлар ва уруғлар; тирик ҳайвонлар; ҳайвонлар учун озуқа ва ичимликлар; солод.',
                ...
                {
                    value: '34',
                    label: '34-Пиво; минерал ва газланган сувлар ва бошқа алкоголсиз ичимликлар; мевали ичимликлар ва мева шарбатлари; сироплар ва бошқа ичимликлар препаратлари',
            ...
            try {
                await axios.post('/api/v1/ex_api/intellektual-huquq', data).then(function (res) {
                    ...
                    if (typeof error.response.data !== 'undefined' && typeof error.response.data.data !== 'undefined') {
                        ...
                        if (typeof error.response.data.data.errorsApps !== 'undefined') _this.setHuquqEgasiErrors(error.response.data.data.errorsApps);
                ...
                case 2:
                    ...
                    setTimeout(async () => {
                        ...
                        if (isValid === true) {
                            ...
                            _this.huquq_egasi.ipHolderTelNumber = (_this.issetVar('application.huquq_egasi_phone')) ? _this.application.huquq_egasi_phone.replaceAll(" ", "") : '';
