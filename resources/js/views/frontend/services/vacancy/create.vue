        ...
        <div class="page-content">
            <div class="container">
                <section id="printme">
                        ...
                        <div class="container">
                            <div class="single-vacancy__main">
                                <div class="d-flex flex-col gap-2 single-vacancy__main-left"><h2
                                    ...
                                    Вояга етмаганлар ишлари бўйича комиссиянинг масъул котиби
                                </h2>
                                    <h2 class="single-vacancy__main-wage py-3"><i class="inline-block">
                                    ...
                                    </i> <span> Штат жадвали бўйича </span></h2>
                                ...
                                <div class="not-print d-flex flex-col single-vacancy__main-right gap-2" id="sub_app">
                                    <div class="not-print d-flex items-center">
                                        <button class="vacancy-btn !text-white !bg-[#3165CB]">
                                            Ариза юбориш
                                        </button> <!----></div>
                                </div>
                            </div>
                    ...
                    <div class="container">
                        <div class="vacancy-description mx-auto">
                            <div class="d-flex align-items-center flex-direction-nav gap-10px ">
                                ...
                                <div class="vacancy-description__card"><span>
                                    ...
                                    <div class="d-flex flex-col gap-4px"><p>Қабул
                                        ...
                                        <div class="d-flex align-end gap-1"><h2>9
                                            кун</h2> <span style="color: #cd5446"
                                                           class=" text-sm font-semibold">6 март 2022
          </span></div>
                                    </div>
                                </div>
                            </div>
                            <div class="vacancy-description__item"><h2>Малакавий
                                талаблар</h2>
                                <p>1) Ижтимой соҳа йўналишларида олий маълумотга эга, олий юридик
                                    мутахассислиги бўлса устунлик беради 2) Одоб-аҳлоқ нормаларига риоя этадиган; 3)
                                    Компьютер саводхонлиги бўйича - Microsoft Word, Exсel ва Power Point дастурларида
                                    юқори даражада ишлай олиши лозим.</p></div>
                            <div class="vacancy-description__item"><h2>Лавозимий
                                мажбуриятлари</h2>
                                <ul>
                                    <li><span>·</span> Ўрнатилган лавозим
                                        йўриқномаси талабларини бажариш
                                    </li>
                                </ul>
                            </div>
                            <div class="vacancy-description__item"><h2>Иш
                                шароитлари</h2>
                                <p>Иш кунлари: душанба, сешанба, чоршанба, пайшанба, жума. Дам олиш
                                    кунлари: шанба, якшанба. Иш вақти: 09: 00 дан 18: 00 гача</p></div>
                            <div class="vacancy-description__item"><h2>Ташкилот
                                тўғрисида маълумот</h2>
                                <div
                                    ...
                                    <div class="md:col-span-4 col-span-12 d-flex flex-col gap-20px">
                                        ...
                                        <div><p>Электрон почта</p> <a
                                            href="mailto:margilansh@umail.uz">
                                            margilansh@umail.uz
                                        </a></div>
                                        <div><p>Телефон рақам</p> <a
                                            href="tel:73-253-30-00, 73-253-15-47">
                                            73-253-30-00, 73-253-15-47
                                        </a></div>
                                    </div>
                                    <div class="md:col-span-4 col-span-12 d-flex flex-col gap-20px">
                                    ...
                                    <div id="map"
                                        ...
                                        <div style="position: relative; overflow: hidden;">
                                            <iframe width="100%" height="auto"
                                                    ...
                                                    src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d191885.50263767486!2d69.13928252010831!3d41.282512545785664!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1643194486766!5m2!1sen!2s"></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@media (max-width: 576px) {
    .single-vacancy__main-right {

        margin-top: 330px;
        margin-left: -94px !important;
    }
    .vacancy-description .vacancy-description__card{
        padding: 10px;
    }
}
