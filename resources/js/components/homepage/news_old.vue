...
<path style="fill:#009688;" d="M245.333,0C109.839,0,0,109.839,0,245.333s109.839,245.333,245.333,245.333
	...
	c18.259,15.858,45.423,15.799,63.612-0.139l118.251-118.251c12.492-12.496,12.492-32.752,0-45.248L290.133,104.533z"/>
        ...
        <p> {{$t("Барча янгиликлар")}} </p></a>
    <div class="container">
        <h3 class="text-center bolimlar_title">{{$t("Қўмита янгиликлари")}}</h3>
...
<!--                <li><a href="#">Тадбирлар</a></li>
        ...
        <div class="row">
            <div class="col-md-12 new_section qalampir_style">


                <div id="carouselExampleDark" class="col-md-7 carousel carousel-dark slide"
                     data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <li v-for="(newsItem,key) in news" data-bs-target="#carouselExampleDark" :data-bs-slide-to="key" :class="key!=0 || 'active'" ></li>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item" :class="key!=0 || 'active'" data-bs-interval="10000"
...
<!--                <div id="carouselExampleDark" class="carousel carousel-dark slide"
                ...
                <div class="col-md-5">
                    <div class="side-news-lists">
                        <div class="news-item"  v-for="(newsItem,key) in news" v-if="key<4" >
                            <div class="news-item-content-img"><img :src="`/storage/uploads/`+ newsItem.image"></div>
