<template>
    <div id="carouselExampleDark" class="carousel carousel-dark slide"
        ...
        <div class="carousel-inner">
            <div class="carousel-item" :class="key!=1 || 'active'" data-bs-interval="10000" v-for="(newsItem,key) in news">
                <div class="col-md-8">
                ...
                <div class="col-md-4">
                    <div class="company_content">
                        <ul class="cats" v-for="(category,catkey) in newsItem.categories">
                            <li><router-link :to="`category/`+category.slug">{{ category.title }}{{ (catkey < newsItem.categories) ? ',' : ''}}</router-link></li>
                        </ul>
                        <div class="about_tittle">
                            <h2> <router-link :to="`news/`+newsItem.slug"> {{ newsItem.title }}</router-link></h2>
                        </div>
                        <div class="date">
                            <svg
                                height="512"
                        ...
                        <div v-html="newsItem.short.substring(0,550)" style="  overflow: hidden; text-overflow: ellipsis; height:200px"></div>
