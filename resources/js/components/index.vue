    ...
    <div>
        <full-page :options="options" ref="fullpage" id="fullpage">
            ...
            <div class="section" id="section0">
                ...
                <!--==========Logo area==========-->
                <div class="top_menu_space" style="height: 60px;width: 100%"></div>
                <!--==========End Logo area==========-->
...
<path style="fill:#009688;" d="M245.333,0C109.839,0,0,109.839,0,245.333s109.839,245.333,245.333,245.333
	...
	c18.259,15.858,45.423,15.799,63.612-0.139l118.251-118.251c12.492-12.496,12.492-32.752,0-45.248L290.133,104.533z"/>
                    ...
                    <div class="slider_inner">
                        ...
                        <div data-thumb="/img/custom/slider-9.png" data-src="/img/custom/slider-9.png">
                            <div class="container">
                                <div class="slider_text absolute_right">
	...
	c18.259,15.858,45.423,15.799,63.612-0.139l118.251-118.251c12.492-12.496,12.492-32.752,0-45.248L290.133,104.533z"/>
                    ...
                    <div class="container">
                        ...
                        <div class="row news_categories_1">
                            <ul>
                                <li><a href="#">Тезкор хабарлар</a></li>
            ...
            <div class="section asosiy_korsatkichlari slide-charts">
                <div class="slider2 ">
                ...
                <div class="container-fluid contact_faq">
                    <div class="row">
                        ...
                        <div class="col-md-6 last_page_right">
                            ...
                            <div class="section_tittle">
                                <h2>2021 Ҳодисалар тақвими</h2>
                            </div>
                            <div class="calendar_wrapper">
                                <div class="top-months">
                                    <div class="month-item active">
                                        <div class="month-text">январь</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">феврал</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">март</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">апрел</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">май</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">июнь</div>
                                    </div>
                                </div>
                                <div class="calendar_content">
                                    <div class="calendar_content-item">
                                        <span>14</span>
                                        <p>Ватан ҳимоячилари куни</p>
                                    </div>
                                    <div class="calendar_content-item">
                                        <span>26</span>
                                        <p>Давлат божхона хизмати ходимлари куни</p>
                                    </div>
                                    <div class="calendar_content-item">
                                        <span>29</span>
                                        <p>Халқаро шахсий маълумотларни ҳимоялаш куни</p>
                                    </div>
                                    <div class="calendar_content-item">
                                        <span>31</span>
                                        <p>Халқаро Интернетсиз куни</p>
                                    </div>
                                ...
                                <div class="footer-months">
                                    <div class="month-item">
                                        <div class="month-text">июль</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">август</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">сентябр</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">октябр</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">ноябр</div>
                                    </div>
                                    <div class="month-item">
                                        <div class="month-text">декабр</div>
                                    </div>
                                </div>
