...
<path style="fill:#009688;" d="M245.333,0C109.839,0,0,109.839,0,245.333s109.839,245.333,245.333,245.333
	...
	c18.259,15.858,45.423,15.799,63.612-0.139l118.251-118.251c12.492-12.496,12.492-32.752,0-45.248L290.133,104.533z"/>
                        ...
                        <div data-thumb="/img/main-slider/slide3.jpg" data-src="/img/main-slider/slide3.jpg">
                            <div class="container">
                                <div class="slider_text absolute_right">
                                    ...
                                    <h4 class="fadeInLeft animated">{{ $t("Божхона ахборот тизими") }}</h4>
                                    <p class="fadeInUp animated">
                                        {{ $t("Чегарадан товарлар олиб ўтишда сертификат ва рухсатномаларни ушбу ахборот тизими ёрдамида олинг.") }}</p>
                        ...
                        <div data-thumb="/img/main-slider/slide4.jpg" data-src="/img/main-slider/slide4.jpg">
                            <div class="container">
                                <div class="slider_text absolute_left">
                                    ...
                                    <h4 class="fadeInLeft animated">{{ $t("Божхона ахборот тизими") }}</h4>
                                    <p class="fadeInUp animated">{{ $t("Божхона хизмати органларидаги вакансиялар рўйхатини билиб олинг ҳамда ишга кириш учун онлайн ариза юборинг") }}</p>
            ...
            <div class="section">
                <div class="row"><h3 class="text-center section_title">{{$t("БЎЛИМЛАР")}}</h3></div>
                <div class="container-fluid">
                    ...
                    <div class="row pb-8" style="margin: 24px!important; justify-content: center;">
                        <router-link
                            ...
                            <div class="bolim_description">{{$t("Жисмоний шахслар учун керакли хизматлар ва маълумотларни билиб олинг")}}
                            </div>
                        </router-link>
                        <router-link to="/page/yuridik-shahslar-tomonidan-avtotransport-vositalarni-olib-kirish-tartibi"
                            ...
                            <div class="bolim_description">{{$t("ТИФ иштирокчилари учун керакли хизматлар ва маълумотларни билиб олинг")}}
                            </div>
                        </router-link>
                        ...
                        <router-link to="/page/votes" class="card">
                            ...
                            <div class="bolim_description">{{$t("Божхона Қўмитасининг очиқ маълумотларини кўчириб олишингиз мумкин")}}
                            </div>
                        </router-link><!--
                        <div class="card">
                            <div class="bolim_image"><img src="/img/service/opendata.png"></div>
                        ...
                        <a href="http://tarif.customs.uz/" target="_blank" class="card">
                            ...
                            <div class="bolim_description">{{$t("Товарлар учун дастлабки ҳисоб – китоблар асосида, сарфланадиган харажат ва вақт")}}
                            </div>
                        ...
                        <a href="http://service.customs.uz/autogtd_report/index.jsp?pc=7#" target="_blank" class="card">
                            ...
                            <div class="bolim_title">{{$t("Тадбиркорлар учун зарур маълумотлар")}}</div>
                            <div class="bolim_description">{{$t("Тадбиркорларнинг экспорт ва импорт маълумотлари")}}</div>
