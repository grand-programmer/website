...
trait PaymeHelper
{
    ...
    public function fillUpBalance($app, $transactionId): void
    {
        $app->giveStatus(5);
        $app->payment_id = $transactionId;
        $app->save();
    }

    public function withdrawBalance($app, $transactionId): void
    {
        $app->payment_id = null;//$transactionId;
        $app->giveStatus(10);
        $app->save();
    }
