...
class NewsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'description' => (isset($request->limit))?'':(isset($translates[0]) ? $translates[0]->description : $this->description),
            'image' => $this->image,
            'short' => (isset($request->limit))?'':(isset($translates[0]) ? $translates[0]->short : $this->short),
            'slug' => $this->slug,
            'viewed' => $this->viewed,
