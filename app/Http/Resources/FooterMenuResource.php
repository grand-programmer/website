...
class FooterMenuResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $translates = DB::table('footer_menu_translates')->where(["menu_id" => $this->id, "language" => app()->getLocale()])->get();
        if($this->type===1){
        ...
        return [
            ...
            'url'=>$url,
            'children'=>($this->children)??FooterMenuResource::collection($this->children)->toArray($request),
        ];
    }
}
