"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_dashboard_components_core_AppBar_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    AppBarItem: {
      render: function render(h) {
        ...
        return h(vuetify__WEBPACK_IMPORTED_MODULE_0__.VHover, {
          scopedSlots: {
            "default": function _default(_ref) {
              var hover = _ref.hover;
              return h(vuetify__WEBPACK_IMPORTED_MODULE_0__.VListItem, {
                attrs: _this.$attrs,
                "class": {
                  'black--text': !hover,
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapState)(['drawer'])),
      ...
      _c(
        ...
        [
          ...
          _c(
            "v-list",
            [
              _c("v-list-item", { attrs: { to: "/user" } }, [_vm._v("Профил")]),
              _vm._v(" "),
              _c(
                "v-list-item",
                {
