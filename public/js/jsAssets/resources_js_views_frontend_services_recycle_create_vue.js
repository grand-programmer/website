"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_frontend_services_recycle_create_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      maqomlar: [{
        text: typeof this.application !== 'undefined' && this.application.rejim === 200 ? "Олиб чиқиладиган товарлар" : "Олиб кириладиган товарлар",
        value: 1
      }, {
        text: typeof this.application !== 'undefined' && this.application.rejim === 200 ? "Ишлатиладиган чет эл товари" : "Ўзбекистон товари",
        value: 2
      }, {
        text: "Қайта ишлаш маҳсулоти",
        value: 3
      }, {
        text: "Қайта ишлашда ҳосил бўладиган иккиламчи товар",
        value: 4
      }, {
        text: "Чиқиндилар",
        value: 5
      }, {
        text: "Йўқ бўлиб кетадиган товарлар",
        value: 6
      }],
      breadcrumb_items: [{
      ...
      app: {
        ...
        common: {
          ...
          ///Viloyat
          repubInOut: null,
          //100 - Bojxona hududida 200- bosjxona tashqarisida
          methodIden: null,
          //
          contractIdenNumber: [],
          //// KONTTYPE : 11,12,16,17 ACTIVE_PR :0
          recycleDeadlineDate: null,
          ///0-24 gacha
          recycleCost: null,
          /// Қайта ишлаш оператцияларининг қиймати *
          recycleCurrency: null,
          //valyuta
          recycleName: null,
          recycleTin: "",
          /// INN
          recycleAddress: null,
          orgPermission: null,
          replProductNm: null //oldAppNum: null
      ...
      fields: [{
        ...
        key: 'methodIden',
        value: 'Идентификация усули'
      }, {
        key: 'locationId',
        value: 'Ҳудудий бошқарма'
      }, {
        key: 'recycleCost',
        value: 'Қайта ишлаш операцияларининг қиймати'
      }, {
        key: 'recycleCurrency',
        value: 'Валюта'
      }, {
        key: 'recycleDeadlineDate',
        value: 'Қайта ишлаш муддати'
      }, {
        key: 'recycleTin',
        value: 'Қайта ишловчи СТИРи'
      }, {
        key: 'contractIdenNumber',
        value: 'Шартнома идентификация рақами'
      }, {
        key: 'recycleAddress',
        value: 'Товар қайта ишланадиган жой манзили'
      }, {
        key: 'orgPermission',
        value: 'Ваколатли органлар рухсатномаси'
      }, {
        key: 'replProductNm',
        value: 'Алмаштириладиган эквивалент товар'
      }, {
        key: 'hsCode',
        value: 'ТИФ ТН код'
      }, {
        ...
        key: 'cmdtNetto',
        value: 'Асосий ўлчов бирлигидаги миқдори'
      }, {
        key: 'cmdtQty',
        value: 'Қўшимча ўлчов бирлигидаги миқдори'
      }],
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                root = _this2;
                _context.next = 3;
                return axios.get('/api/v1/data/currency?lang=uz').then(function (result) {
                  var currencies = [];
    ...
    addSubProduct: function addSubProduct(key) {
      ...
      if (typeof this.application.tovarlar[this.application.subProduct.id] !== 'undefined') {
        if (this.application.tovarlar.filter(function (tovar) {
          if (tovar.id === _this.application.subProduct.id) return tovar;
        }).length > 0) subProduct['tovar'] = JSON.parse(JSON.stringify(this.application.tovarlar.filter(function (tovar) {
          if (tovar.id === _this.application.subProduct.id) return tovar;
        })[0]));
        subProduct['miqdor'] = this.application.subProduct.miqdor;
        if (typeof this.application.tovarlar[key].subProducts === 'undefined' || !this.application.tovarlar[key].subProducts) this.application.tovarlar[key].subProducts = [];
        ...
        this.application.subProduct = JSON.parse(JSON.stringify({
          id: null,
          miqdor: null
        }));
      }
    ...
    issetProductswithStatus: function issetProductswithStatus() {
      var returnData = this.application.tovarlar.filter(function (obj) {
        if (typeof obj.status !== 'undefined' && obj.status) return obj;
      });
      if (returnData.length > 0) return true;
      return false;
    },
    getProductsByStatus: function getProductsByStatus(val) {
      return this.application.tovarlar.filter(function (obj) {
        if (obj.status === val) return obj;
      });
    },
    getProductsByID: function getProductsByID(val) {
      return this.application.tovarlar.filter(function (obj) {
    ...
    isValidDoc: function isValidDoc() {
      ...
      if (index) {
        ...
        if (typeof this.application.documents !== 'undefined') this.application.documents.forEach(function (document, k) {
    ...
    openDocumentType: function openDocumentType() {
      ...
      this.documents = []; //let object = this.filterObject(this.application.tovarlar, this.tovarIndex, 'id')
      //if (object)
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return axios.get("/api/v1/ex_api/gen_session").then(function (response) {
    ...
    authorizeToEArxiv: function authorizeToEArxiv() {
      var _this3 = this;

      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
        var _this, result_data;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                result_data = _context3.sent;

                if (result_data && result_data.status === 200) {
                  $("#SessionID").attr('value', result_data.data.data.sesid);
                  $("#serialNumberHex").attr('value', result_data.data.data.serialnumber); //$("#serialNumberHex").attr('value',result_data.data.data.serialnumber)

                  $("#INN").attr('value', result_data.data.data.userinn);
                  $("#PNFL").attr('value', _this.$auth.user().pin);
                  $("#username").attr('value', result_data.data.data.name.replaceAll("", "'")); ///*_this.$toast.success(result_data.data.data.name)
    ...
    AddProduct: function AddProduct() {
      var copytovar = JSON.parse(JSON.stringify(this.copytovar));
      var max = 0; //const keys = Object.keys(this.application.tovarlar);
    ...
    RemoveProduct: function RemoveProduct(product) {
      ...
      var k = 0;
      var selected = this.application.tovarlar.filter(function (obj, key) {
        if (obj.id === product) {
          k = key;
          return obj;
        }
      ...
      if (this.application.tovarlar.length > 1) {
        setTimeout(function () {
          if (typeof selected[0] !== 'undefined') {
            k = _this4.application.tovarlar.indexOf(selected[0]);

            if (k !== -1) {
              _this4.application.tovarlar.splice(k, 1);

              _this4.removeWatcher(selected[0].id);
            }
          }

          if (typeof _this4.application.tovarlar[k - 1] !== 'undefined' && typeof _this4.application.tovarlar[k - 1].id !== 'undefined') {
            _this.tovarIndex = _this4.application.tovarlar[k - 1].id;
          } else {
            _this.tovarIndex = JSON.parse(JSON.stringify(_this4.application.tovarlar[0].id)); //JSON.parse(JSON.stringify(this.application.tovarlar[this.application.tovarlar.indexOf(selected[0])].id));
          }
        }, 1);
    ...
    sendPerson: function sendPerson() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.prev = 5;
                _context4.next = 8;
                return axios.post('/api/v1/ex_api/recycle-person', data).then(function (res) {
                  result = res;
                });
    ...
    sendCommon: function sendCommon() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                data = _arguments2.length > 0 && _arguments2[0] !== undefined ? _arguments2[0] : null;
                result = null;
                _context5.prev = 2;
                _context5.next = 5;
                return axios.post('/api/v1/ex_api/recycle-common', data).then(function (res) {
                  result = res;
                })["catch"](function (inValidErrors) {
    ...
    sendProduct: function sendProduct(data) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                ...
                _context6.prev = 1;
                _context6.next = 4;
                return axios.post('/api/v1/ex_api/recycle-product', data).then(function (res) {
                  result = res;
                });
    ...
    checkFile: function checkFile(file_id) {
      var _this5 = this;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                response = null;
                _context7.next = 3;
                return axios.get('/api/v1/ex_api/arxiv?file_id=' + file_id + '&pnfl=' + _this5.$auth.user().pin);
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                ...
                _context11.t0 = _this6.stepper;
                _context11.next = _context11.t0 === 1 ? 5 : _context11.t0 === 2 ? 8 : _context11.t0 === 3 ? 11 : _context11.t0 === 4 ? 16 : 19;
                break;
                    ...
                    while (1) {
                      switch (_context8.prev = _context8.next) {
                        ...
                        case 2:
                          ...
                          _context8.next = 10;
                          return _this6.sendPerson(JSON.parse(JSON.stringify(_this6.person)));
                        ...
                        case 10:
                          ...
                          if (resultData && typeof resultData.data !== 'undefined' && resultData.data.success === true) {
                            ...
                            _this6.person.person_id = resultData.data['data']['data']['id'];

                            _this6.$cookie["delete"]('user');

                            _this6.$cookie.set('user', JSON.stringify(_this6.person), 1);
                          ...
                          } else _this6.$toast.error("Маълумотлар киритишда хатолик юз берди. Қайта уриниб кўринг!");
              ...
              case 8:
                _this6.loadingButton.second = true; //console.log(!this.validateField("create_customs_person_value"))
                    ...
                    while (1) {
                      switch (_context9.prev = _context9.next) {
                        case 0:
                          ...
                          if (_this.application.method === 5) _this.app.common.methodIden = _this.application.method2;else {
                            if (_this.application.method > 0 || _this.application.method < 5) {
                              if (_this.application.rejim === 200) _this.app.common.methodIden = _this.methodIdentificationsOut.filter(function (item) {
                                if (item.value === _this.application.method) return item;
                              })[0].text;else _this.app.common.methodIden = _this.methodIdentificationsIn.filter(function (item) {
                                if (item.value === _this.application.method) return item;
                              })[0].text;
                            }
                          } //
                          ...
                          _context9.next = 18;
                          return _this6.sendCommon(JSON.parse(JSON.stringify({
                        ...
                        case 18:
                          ...
                          if (resultData && resultData.data && resultData.data.success === true) {
                            _this6.$cookie["delete"]('common');

                            _this6.$cookie.set('common', JSON.stringify({
                            ...
                            if (typeof resultData.data !== 'undefined' && resultData.data && typeof resultData.data.data !== 'undefined' && resultData.data.data && typeof resultData.data.data.errors !== 'undefined' && _typeof(resultData.data.data.errors)) {
                              ...
                              if (typeof resultData.data.data.errors.docsBody !== 'undefined') {
                                ...
                                if (typeof resultData.data.data.errors.docsBody === 'String') _this.application.ilova_error = resultData.data.data.errors.docsBody;
                              ...
                              _this6.$toast.error("Маълумотларингизни тўғрилаб юборинг!");
                            } else _this6.$toast.error("Маълумотлар киритишда хатолик юз берди. Қайта уриниб кўринг!");
                          }
              ...
              case 11:
                count = 0; //this.$refs["create_customs_tovar4_value" + this.tovarIndex][0].syncValue()

                _this6.loadingButton.third = true; //setTimeout(async () => {

                setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee10() {
                  var resultData;
                      ...
                      switch (_context10.prev = _context10.next) {
                        case 0:
                          ...
                          _this.application.tovarlar.forEach(function (tovar) {
                            ...
                            if (typeof tovar.subProducts !== 'undefined' && tovar.subProducts && tovar.subProducts.length > 0) {
                              tovar.subProducts.forEach(function (item) {
                                _this.application.tovarlar.map(function (x) {
                          ...
                          _context10.next = 4;
                          return _this6.sendProduct(_this.app.commodities);
                        ...
                        case 4:
                          ...
                          if (typeof resultData !== 'undefined' && typeof resultData.data !== 'undefined' && typeof resultData.data.success !== 'undefined' && resultData.data.success === true) {
                            ...
                            _this6.$toast.success("Сизнинг аризангиз омадли тарзда юборилди!");
                            ...
                            if (resultData.status === 400) {
                              if (typeof resultData.data.data !== 'undefined' && typeof resultData.data.data.errorsCommodity !== 'undefined') {
                                Object.entries(resultData.data.data.errorsCommodity).forEach(function (_ref4) {
                                  var _ref5 = _slicedToArray(_ref4, 2),
                                      key = _ref5[0],
                                      value = _ref5[1];

                                  if (typeof value['commodityBody'] !== 'undefined') _this.setProductErrors(key, value['commodityBody']);
                              ...
                              } else _this6.$toast.error("Маълумотларингизни текшириб қайтадан юборинг!");
                            } else _this6.$toast.error("Маълумотлар киритишда хатолик юз берди. Қайта уриниб кўринг!");
                ...
                _this6.loadingButton.second = false; // },3000);
                //isValid = true;
              ...
              case 16:
                ...
                _this6.completedSteps.push(_this6.stepper - 1);
    ...
    editSubProduct: function editSubProduct(item, tovarKey) {
      var _this8 = this;

      var _this = this;

      this.application.tovarlar[tovarKey].subProducts.forEach(function (subItem) {
        if (subItem.id === item.id) {
          var indexSubItem = _this.application.tovarlar[tovarKey].subProducts.indexOf(subItem);
          ...
          _this8.editedSubProducts.push(subItem.id);
        }
      });
    },
    deleteSubProduct: function deleteSubProduct(item, tovarKey) {
      var _this = this;
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                _this10.postloading = true;
                _this = _this10;
                _this10.posts = [];
                _context14.next = 5;
                return axios.get('/api/v1/ex_api/posts?code=' + code).then(function (result) {
                  if (typeof result.data.locations !== 'undefined') result.data.locations.forEach(function (item) {
                    _this.posts.push({
                      'value': item['code'],
                      'text': item['cdNm']
                    });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee15$(_context15) {
          while (1) {
            switch (_context15.prev = _context15.next) {
              case 0:
                _this11.dialog.documenttype = false;
    ...
    setCommonData: function setCommonData(data) {
      ...
      if (typeof data.common !== 'undefined') {
        ...
        if (data.common && typeof data.common.contractIdenNumber !== 'undefined') {
          data.common.contractIdenNumber.forEach(function (contract) {
            setTimeout(function () {
        ...
        if (data.docs && typeof data.docs !== 'undefined') {
          data.docs.forEach(function (file) {
            if (typeof file['fileId'] !== 'undefined') _this.application.documents.push({
              id: file['fileId']
            });
          });
        }
            ...
            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee16$(_context16) {
              while (1) {
                switch (_context16.prev = _context16.next) {
                  case 0:
                    _context16.next = 2;
                    return fetch(window.location.origin + "/api/v1/data/inn?code=" + data.common.recycleTin).then(function (res) {
                      return res.json();
                    }).then(function (res) {
                      ...
                      _this12.recycle_orgs = res;
                    });

                  case 2:
                    _this.recycle_orgs.filter(function (item) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee17$(_context17) {
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                silent = _arguments3.length > 0 && _arguments3[0] !== undefined ? _arguments3[0] : false;
                isValid = false;
                _context17.next = 4;
                return _this13.$refs['create_customs_person_value'].validate({
                  silent: silent
                });
    ...
    Initprogress: function Initprogress(val) {
      if (val) return Math.min(100, val.length * 8);else return 0;
    },
    myColor: function myColor(val, key) {
      var _this14 = this;
          ...
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                _this = _this14;
                fileIsset = false;
                if (_this14.application.documents[key] && _this14.application.documents[key]['id'] === val) _this14.documents[key].color = 'success';
                ...
                _context18.next = 6;
                return _this14.checkFile(val);

              case 6:
                fileIsset = _context18.sent;

                if (fileIsset && fileIsset.length > 0) {
                  if (typeof _this14.application.documents !== 'undefined' && typeof _this14.application.documents[key] !== 'undefined') {
                    _this14.application.documents[key]['id'] = val;
                    _this14.application.documents[key]['type'] = fileIsset[0].cd_id + " - " + fileIsset[0].file_num;
                    _this14.documents[key].color = 'success';
                    _this14.documents[key].valid = true;
                  } else {
                    _this14.application.documents.push({
                      id: val,
                  ...
                  _this14.documents[key].color = 'warning';
                  _this14.documents[key].valid = false;
                }
              ...
              case 12:
                if (val.length < 13) {
                  _this14.documents[key].color = ['error', 'warning'][Math.floor(_this14.Initprogress(val) / 50)];
                  _this14.documents[key].valid = false;
                }
    ...
    remove: function remove(item) {
      var index = this.application.tovarlar[this.tovarIndex].tftn.indexOf(item);
    ...
    createWatcher: function createWatcher(key) {
      var _this15 = this;

      var _this = this;

      this.$watch('application.tovarlar.' + key + '.search_tftn', function (val) {
        // console.log(val)
        if (val === null || val && val.length > 10) return;
        _this15.loading.tftncode = true; // Lazily load input items

        fetch("https://new.customs.uz/api/v1/data/tftn?code=" + val).then(function (res) {
          return res.json();
        }).then(function (res) {
          res.map(function (item) {
          ...
          return _this15.loading.tftncode = false;
        });
      });
      this.$watch('application.tovarlar.' + key + '.status', function (val) {
        _this.application.tovarlar.sort(function (a, b) {
    ...
    removeWatcher: function removeWatcher(key) {
      var unwatch = this.$watch('application.tovarlar.' + key + '.search_tftn');
      unwatch();
    },
    resetVar: function resetVar(myVar) {
      ...
      if (_typeof(myVar) === 'object') {
        Object.entries(myVar).forEach(function (_ref8) {
  ...
  watch: {
    search_inn: {
      handler: function handler(val) {
        ...
        if (!val) return;
        if (val.length !== 9) return; //if (this.tftncodes.length > 0) return
        // Items have already been requested
        //if (this.loading.tftncode) return

        this.loading.recycle_org = true; // Lazily load input items

        fetch(window.location.origin + "/api/v1/data/inn?code=" + val).then(function (res) {
          return res.json();
        }).then(function (res) {
          res.map(function (item) {
            item.shortname = item.tin + " - " + item.shortname;
          ...
          _this16.loading.recycle_org = false;
          _this16.recycle_orgs = res;
        })["catch"](function (err) {
          console.log(err);
        })["finally"](function () {
          return _this16.loading.recycle_org = false;
        });
      },
      deep: true
    },
    search_contract: {
      handler: function handler(val) {
        ...
        if (!val) return; //if (val.length ) return
        //if (this.tftncodes.length > 0) return
        // Items have already been requested
        //if (this.loading.tftncode) return

        this.loading.contract = true; // Lazily load input items

        fetch(window.location.origin + "/api/v1/data/contract?code=" + val).then(function (res) {
          return res.json();
        }).then(function (res) {
          _this17.loading.contract = false; //this.contracts.push(res.data[0]);

          _this17.contracts = _this17.contracts.concat(res.data.filter(function (item) {
            return _this17.contracts.indexOf(item) < 0;
          }));
        })["catch"](function (err) {
          console.log(err);
        })["finally"](function () {
          return _this17.loading.contract = false;
        });
      },
      deep: true
    },
    "application.recycle_org": {
      handler: function handler(val) {
        ...
        if (!val.tin) return;
        if (val.tin.length !== 9) return; //if (val.length ) return
        //if (this.tftncodes.length > 0) return
        // Items have already been requested
        //if (this.loading.tftncode) return
        ...
        fetch(window.location.origin + "/api/v1/data/contract?inn=" + val.tin).then(function (res) {
          return res.json();
        }).then(function (res) {
          _this18.loading.contract = false; //this.contracts.push(res.data[0]);

          _this18.contracts = _this18.contracts.concat(res.data.filter(function (item) {
            return _this18.contracts.indexOf(item) < 0;
          }));
        })["catch"](function (err) {
          console.log(err);
        })["finally"](function () {
          return _this18.loading.contract = false;
        });
      },
      deep: true
    }
  ...
  computed: {
    ...
    isvalidDocument: function isvalidDocument() {
      var tovar_id = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    getProducts: function getProducts() {
      if (this.application.tovarlar.length > 0) {
        return this.application.tovarlar.sort(function (a, b) {
    ...
    listForSubProduct: function listForSubProduct() {
      var _this = this;

      if (typeof _this.application.tovarlar.filter(function (tovar) {
        if (_this.tovarIndex === tovar.id) return tovar;
      })[0] !== 'undefined' && typeof _this.application.tovarlar.filter(function (tovar) {
        if (_this.tovarIndex === tovar.id) return tovar;
      })[0].subProducts !== 'undefined') {
        return this.getProductsByStatus(1).concat(this.getProductsByStatus(2)).filter(function (item) {
          var returnData = true;
          var myList = JSON.parse(JSON.stringify(_this.application.tovarlar.filter(function (tovar) {
            if (_this.tovarIndex === tovar.id) return tovar;
          })));

          if (typeof myList[0] !== 'undefined' && myList[0].subProducts !== 'undefined') {
            myList[0].subProducts.filter(function (subProduct) {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=style&index=0&lang=css&":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./resources/js/views/frontend/services/recycle/create.vue":
/*!*****************************************************************!*\
  !*** ./resources/js/views/frontend/services/recycle/create.vue ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _create_vue_vue_type_template_id_33cdd46a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create.vue?vue&type=template&id=33cdd46a& */ "./resources/js/views/frontend/services/recycle/create.vue?vue&type=template&id=33cdd46a&");
/* harmony import */ var _create_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create.vue?vue&type=script&lang=js& */ "./resources/js/views/frontend/services/recycle/create.vue?vue&type=script&lang=js&");
/* harmony import */ var _create_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./create.vue?vue&type=style&index=0&lang=css& */ "./resources/js/views/frontend/services/recycle/create.vue?vue&type=style&index=0&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _create_vue_vue_type_template_id_33cdd46a___WEBPACK_IMPORTED_MODULE_0__.render,
  _create_vue_vue_type_template_id_33cdd46a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/frontend/services/recycle/create.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/frontend/services/recycle/create.vue?vue&type=script&lang=js&":
/*!******************************************************************************************!*\
  !*** ./resources/js/views/frontend/services/recycle/create.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_create_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./create.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_create_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/views/frontend/services/recycle/create.vue?vue&type=style&index=0&lang=css&":
/*!**************************************************************************************************!*\
  !*** ./resources/js/views/frontend/services/recycle/create.vue?vue&type=style&index=0&lang=css& ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/frontend/services/recycle/create.vue?vue&type=template&id=33cdd46a&":
/*!************************************************************************************************!*\
  !*** ./resources/js/views/frontend/services/recycle/create.vue?vue&type=template&id=33cdd46a& ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_create_vue_vue_type_template_id_33cdd46a___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_create_vue_vue_type_template_id_33cdd46a___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_create_vue_vue_type_template_id_33cdd46a___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./create.vue?vue&type=template&id=33cdd46a& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=template&id=33cdd46a&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=template&id=33cdd46a&":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/frontend/services/recycle/create.vue?vue&type=template&id=33cdd46a& ***!
  \***************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function () {
  ...
  return _c(
    "div",
    { staticClass: "section customs-value-section service-recycle" },
    [
      _c(
        "div",
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        "v-stepper-step",
                        {
                          attrs: { complete: _vm.isCompleted(3), step: "3" },
                          on: {
                            click: function ($event) {
                              return _vm.goStep(3)
                            },
                  ...
                  _c(
                    ...
                    [
                                                            ...
                                                            _c(
                                                              "autocomplete-field",
                                                              {
                                                                attrs: {
                                                                  options: [
                                                                    {
                                                                      text: "Божхона ҳудудида қайта ишлаш",
                                                                      value: 100,
                                                                    },
                                                                    {
                                                                      text: "Божхона ҳудудидан ташқарида қайта ишлаш",
                                                                      value: 200,
                                                                    },
                                                                  ],
                                                                  rules:
                                                                ...
                                                                attrs: {
                                                                  options:
                                                                    _vm
                                                                      ...
                                                                      .rejim ===
                                                                    200
                                                                      ? _vm.methodIdentificationsOut
                                                                      : _vm.methodIdentificationsIn,
                                                                  title:
                                                                    "Идентификация усули",
                                                                  rules:
                                                                    "required",
                                                        ...
                                                        _c(
                                                          ...
                                                          [
                                                            _c(
                                                              ...
                                                              {
                                                                attrs: {
                                                                  name: "Бошқа идентификация усули",
                                                                  rules:
                                                                    "required",
                                                                },
                                                                scopedSlots:
                                                        ...
                                                        _c(
                                                          ...
                                                          [
                                                            _c(
                                                              ...
                                                              {
                                                                attrs: {
                                                                  name: "Қайта ишлаш операцияларининг қиймати",
                                                                  rules:
                                                                    "required",
                                                                },
                                                                scopedSlots:
                                                            ...
                                                            _c(
                                                              "ValidationProvider",
                                                              {
                                                                attrs: {
                                                                  ...
                                                                  rules:
                                                                    "required|max_value:24|numeric|between:1,24",
                                                                },
                                                                scopedSlots:
                                                                  _vm._u(
                                                                    [
                                                        ...
                                                        _c(
                                                          ...
                                                          [
                                                            _c(
                                                              ...
                                                              {
                                                                attrs: {
                                                                  name: "Товар қайта ишланадиган жой манзили",
                                                                  rules:
                                                                    "required",
                                                                },
                                                                scopedSlots:
                                      ...
                                      _c(
                                        "v-btn",
                                        {
                                          attrs: {
                                            color: "primary",
                                            size: "large",
                                            loading: _vm.loadingButton.second,
                                          },
                                          on: { click: _vm.nextStep },
                                        },
                                        [
                      ...
                      _c(
                        "v-stepper-content",
                        {
                          staticClass: "recyle-product-wrapper",
                          attrs: { step: "3" },
                        },
                        [
                          _c(
                            "div",
                            { staticClass: "p-1 d-flex align-items-start" },
                            [
                              _c(
                                "div",
                                {
                                  staticClass:
                                    "nav flex-column p-0 nav-pills col-1 product_parts",
                                  attrs: {
                                    id: "v-pills-tab",
                                    role: "tablist",
                                ...
                                [
                                  ...
                                  _c(
                                    "div",
                                    { staticClass: "product-button-actions" },
                                    _vm._l(
                                      _vm.getProducts,
                                      function (tovar, key) {
                                        return _c(
                                          "button",
                                          {
                                            ...
                                            class:
                                              _vm.application.tovarlar[key]
                                                .id === _vm.tovarIndex
                                                ? "active"
                                                : "",
                                            style:
                                              "border-bottom:3px solid " +
                                              _vm.colors[tovar.status - 1],
                                            attrs: {
                                              id:
                                                "v-pills-profile-tab" +
                                                tovar.id,
                              ...
                              _c(
                                "div",
                                {
                                  staticClass: "tab-content w-100",
                                  attrs: { id: "v-pills-tabContent" },
                                },
                                _vm._l(_vm.getProducts, function (tovar, key) {
                                  return _c(
                                    "div",
                                    {
                                      key: key,
                                      ...
                                      class:
                                        tovar.id === _vm.tovarIndex
                                          ? "list-enter-active active"
                                          : "list-move",
                                      attrs: {
                                        id: "v-pills-profile" + tovar.id,
                                        role: "tabpanel",
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                "v-row",
                                                {
                                                  staticClass: "p-2 my-2 mx-1",
                                                  attrs: { flat: "" },
                                                },
                                                [
                                                  _c("ValidationObserver", {
                                                    ref:
                                                      "stepValidation2Product" +
                                                      key,
                                                    refInFor: true,
                                                    scopedSlots: _vm._u(
                                                      [
                                                                                          ...
                                                                                          model:
                                                                                            {
                                                                                              ...
                                                                                              expression:
                                                                                                "application.tovarlar[key].status",
                                                                                            },
                                                                                        }
                                                                                      ),
                                                                                      _vm._v(
                                                                                          ...
                                                                                          model:
                                                                                            {
                                                                                              ...
                                                                                              expression:
                                                                                                "application.tovarlar[key].nomlanishi",
                                                                                            },
                                                                                        }
                                                                                      ),
                                                                                      _vm._v(
                                                                                          ...
                                                                                          model:
                                                                                            {
                                                                                              ...
                                                                                              expression:
                                                                                                "application.tovarlar[key].qiymati",
                                                                                            },
                                                                                        }
                                                                                      ),
                                                                                      _vm._v(
                                                                                          ...
                                                                                          model:
                                                                                            {
                                                                                              ...
                                                                                              expression:
                                                                                                "application.tovarlar[key].currency",
                                                                                            },
                                                                                        }
                                                                                      ),
                                                                                      _vm._v(
                                                                                          ...
                                                                                          model:
                                                                                            {
                                                                                              ...
                                                                                              expression:
                                                                                                "application.tovarlar[key].weight",
                                                                                            },
                                                                                        }
                                                                                      ),
                                                                                      _vm._v(
                                            ...
                                            [
                                              _c(
                                                ...
                                                [
                                                  ...
                                                  _vm._v(
                                                    " - майдонлари албатта тўлдирилиши\n                                            шарт!"
                                                  ),
                                                ]
                                              ),
                                            ]
                          ...
                          _c(
                            "v-row",
                            { staticClass: "row mb-0 bottom-0 end-0" },
                            [
                              _c(
                                "v-col",
                                [
                                  _c(
                                    "v-dialog",
                                    {
                                      ...
                                      model: {
                                        value: _vm.dialog.tovarlarresult,
                                        callback: function ($$v) {
                                          _vm.$set(
                                            _vm.dialog,
                                            "tovarlarresult",
                                        ...
                                        expression: "dialog.tovarlarresult",
                                      },
                                    },
                                    [
                                      _vm._v(" "),
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                [
                                                  _vm._v(
                                                    " Киритилган товарлар рўйхати мақомлар кесимида "
                                                  ),
                                                ]
                                              ),
                                            ]
                                                  ...
                                                  _c(
                                                    ...
                                                    [
                                                      ...
                                                      _vm._l(
                                                        _vm.statusList,
                                                        function (item) {
                                                          return _vm.getProductsByStatus(
                                                            item.value
                                                          ).length > 0
                                                            ? _c(
                                                                "v-tab",
                                            ...
                                            [
                                              ...
                                              _c(
                                                "v-btn",
                                                {
                                                  ...
                                                  on: {
                                                    click: function ($event) {
                                                      _vm.dialog.tovarlarresult = false
                                                    },
                                                  },
                                                },
                                                [
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "d-flex tab_action_buttons justify-content-end p-0",
                                },
                                [
                                  _c(
                                    "v-btn",
      ...
      _c(
        "form",
        {
          ...
          staticClass: "d-none",
          attrs: {
            action: "https://ed2.customs.uz/E_ARXIV/authentication",
            method: "post",
            target: "_blank",
          },
        },
        [
          _c("input", {
            attrs: { type: "hidden", id: "SessionID", name: "SessionID" },
          }),
          _c("br"),
          _vm._v(" "),
          _c("input", {
          ...
          _vm._v(" "),
          _c("input", {
            attrs: { type: "hidden", id: "YUR_INN", name: "YUR_INN" },
          }),
          _c("br"),
          _vm._v(" "),
          _c("input", {
          ...
          _c("input", {
            attrs: {
              ...
              id: "username",
              name: "username",
              value: "МУРАДОВ ФАРРУХ ШАКИРОВИЧ",
            },
          }),
          _c("br"),
          _vm._v(" "),
          _c("input", {
            attrs: { type: "hidden", id: "ETR", name: "ETR", value: "ETR" },
          }),
          _c("br"),
        ]
      ),
  ...
  function () {
    ...
    return _c(
      "a",
      {
        ...
        attrs: { target: "_blank", href: "https://t.me/bojxonaqaytaishlash" },
      },
      [
