                    ...
                    _c(
                      "a",
                      {
                        attrs: {
                          href:
                            _vm.$i18n.locale === "uz"
                              ? "/storage/files/stamp_uz.pptx"
                              : "/storage/files/stamp_ru.pptx",
                        },
                      },
                      [
                        _vm._v(
                                    ...
                                    [
                                      _c("textfield", {
                                        attrs: {
                                          ...
                                          hint: _vm.$t(
                                            "Автотранспорт воситаси рўйхатдан ўтказилганлиги тўғрисида гувоҳнома (техпаспорт) серия рақами"
                                          ),
                                          rules: "required",
                                        },
                                        model: {
                                ...
                                [
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("textfield", {
                                        attrs: {
                                          title: _vm.$t("Ташқи ўлчамлари"),
                                          rules: "required",
                                          hint: _vm.$t(
                                            "смда, Мисол: 1289,5*235*239,2"
                                          ),
                                        },
                                        model: {
                                    ...
                                    [
                                      _c("textfield", {
                                        attrs: {
                                          ...
                                          rules: "required",
                                          hint: _vm.$t(
                                            "материал типи, конструкция тури ва бошқа. Мисол: Темирдан ясалган, йиғилмайдиган"
                                          ),
                                        },
                                        model: {
                                ...
                                [
                                  _c("e-arxiv-file", {
                                    attrs: {
                                      multiple: "",
                                      label: _vm.$t(
                                        "Транспорт воситаси расмлари"
                                      ),
                                      errors: _vm.ilova_error,
                                      hint: _vm.$t(
                                        "Транспорт воситасининг чап тарафи, Транспорт воситасининг ўнг тарафи, Транспорт воситасининг олди, Транспорт воситасининг орқаси, Пломбалар ва муҳрлар қўйиладиган жой"
                                      ),
                                    },
                                    model: {
                                      value: _vm.app.files,
