        ...
        axios.get("/api/v1/ex_api/stamp-get", {
          ...
          if (typeof response.data.data !== "undefined") {
            ...
            _this.breadcrumb_items.push({
              text: _i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t("Транспорт воситасига товарларни божхона пломбалари ва муҳрлари остида ташишга рухсат бериш -") + _this.app.appNum,
