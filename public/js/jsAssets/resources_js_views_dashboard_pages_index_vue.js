...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    initialize: function initialize() {
      ...
      _src_services_adminApi__WEBPACK_IMPORTED_MODULE_0__["default"].readPages().then(function (response) {
    ...
    deleteItemConfirm: function deleteItemConfirm() {
      ...
      _src_services_adminApi__WEBPACK_IMPORTED_MODULE_0__["default"].deletePage(this.editedItem.id).then(function (response) {
