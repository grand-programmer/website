...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    telegram: function telegram(news) {
      var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this2.$toast.error('Аллақачон жойланган');

                _this2.loading.telegram = false;
                return _context.abrupt("return");

              case 5:
                _context.next = 7;
                return axios.put("/api/v1/admin/news/" + _this2.$route.params.id, {
                  telegram: true
                }).then(function (res) {
                  if (res.status === 200) {
                    _this2.$toast.success('Янгилик телеграм каналга юборилди');

                    _this2.loading.telegram = false;
                    _this2.news.telegram = true;
                  } else {
    ...
    getLang: function getLang() {
      ...
      if (code) {
        ...
        var _language = this.languages.filter(function (language) {
          if (language.value === _this3.lang) return language;
        });
    ...
    initialize: function initialize() {
      ...
      _src_services_adminApi__WEBPACK_IMPORTED_MODULE_1__["default"].readOneNews(this.$route.params.id).then(function (response) {
        _this4.news = response.data.data;

        if (typeof _this4.news.categories !== 'undefined' && _this.news.categories) {
          _this.news['cats'] = [];
        ...
        _this4.preview = "/storage/uploads/" + _this4.news.image;
        _this4.news.image = null; //"/storage/uploads/"+this.news.image;

        delete _this4.news.image; //"/storage/uploads/"+this.news.image;
      })["catch"](function (error) {
        console.log(error);

        _this4.$router.replace("/admin/news")["catch"](function () {});
      });
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this6.$refs.newsForm.validate();
              ...
              case 2:
                ...
                if (isValid) {
                  ...
                  for (key in _this6.news) {
                    if (key !== 'telegram') {
                      if (Array.isArray(_this6.news[key]) || key === 'cats') {
                        for (category in _this6.news[key]) {
                          data.append(key + '[]', _this6.news[key][category]);
                        }
                      } else data.append(key, _this6.news[key]);
                    }
                  }

                  data.append("_method", "put");
                  data.append("translates", JSON.stringify(_this6.langtext));
                  _src_services_adminApi__WEBPACK_IMPORTED_MODULE_1__["default"].updateNews(_this6.news.id, data).then(function (response) {
                    _this6.$toast.success("\u041C\u0430\u044A\u043B\u0443\u043C\u043E\u0442\u043B\u0430\u0440\u043D\u0438 \u043E\u043C\u0430\u0434\u043B\u0438 \u0442\u0430\u0440\u0437\u0434\u0430 \u044E\u043A\u043B\u0430\u043D\u0434\u0438!");
                  })["catch"](function (error) {
                    _this6.$toast.error(i18n.t("\u041C\u0430\u044A\u043B\u0443\u043C\u043E\u0442\u043B\u0430\u0440\u043D\u0438 \u044E\u043A\u043B\u0430\u0448\u0434\u0430 \u0445\u0430\u0442\u043E\u043B\u0438\u043A \u0441\u043E\u0434\u0438\u0440 \u0431\u045E\u043B\u0434\u0438!"));
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/news/edit.vue?vue&type=style&index=0&lang=css&":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-13[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/dashboard/news/edit.vue?vue&type=style&index=0&lang=css& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
