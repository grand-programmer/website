...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    initialize: function initialize() {
      ...
      _src_services_adminApi__WEBPACK_IMPORTED_MODULE_0__["default"].readAppeals().then(function (response) {
    ...
    deleteItemConfirm: function deleteItemConfirm() {
      ...
      _src_services_adminApi__WEBPACK_IMPORTED_MODULE_0__["default"].deleteAppeal(this.editedItem.id).then(function (response) {
