  ...
  data: function data() {
    return {
      breadcrumb_items: [{
        ...
        text: _i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('Расмийлаштирилган божхона юк декларациялари тўғрисидаги маълумотларни олиш'),
        to: '/services/stat',
        disabled: true,
        exact: true
      }],
      ...
      panels: [{
        ...
        content: [_i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t("Аризачи ЯИДХПда рўйхатдан ўтади, ариза шаклини тўлдиради ва ваколатли органга юборади"), this.$t("Тизим томонидан ариза кўриб чиқилиб, тўлов қилинган бўлса натижаси кўрсатилади.")]
      }, {
        ...
        content: [_i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('Юридик шахслар')]
      }, {
        ...
        content: ['<a href="https://lex.uz/docs/3844549">' + _i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t('Товарларни божхонада электрон шаклда декларациялаш тартибини янада такомиллаштириш тўғрисида') + '</a>']
      }, {
        title: _i18n__WEBPACK_IMPORTED_MODULE_0__["default"].t("Хизмат нархи"),
        content: ["<p><strong>Божхона юк декларацияси ва илова хужжатларини юклаб олиш нархи:</strong></p>\n" + "<ul>\n" + "<li>битта божхона юк декларациясини юклаб олиш БҲМнинг 1%</li>\n" + "<li>божхона декларациясига юклаб олинган хар бир хужжат турини юклаб олиш БҲМнинг 1%</li>\n" + "</ul>\n" + "<p><strong>Жадвал кўринишидаги маълумотларни юклаб олиш нархи:</strong></p>\n" + "<ul>\n" + "<li>100 та қаторгача (товар) &ndash; БҲМ 5%</li>\n" + "<li>300 та қаторгача (товар) &ndash; БҲМ 10%</li>\n" + "<li>700 та қаторгача (товар) &ndash; БҲМ 20%</li>\n" + "<li>1500 та қаторгача (товар) &ndash; БҲМ 50%</li>\n" + "<li>5000 та қаторгача (товар) &ndash; 1 БҲМ</li>\n" + "<li>15000 та қаторгача (товар) &ndash; 2 БҲМ</li>\n" + "<li>15001 тадан ортиқ қаторгача (товар) &ndash; 3 БҲМ</li>\n" + "<li>Қўшимча ҳар бир графа учун &ndash; кўрсатилган хизмат нархининг 5%</li>\n" + "</ul>"]
      }]
    };
  },
  methods: {
    gotoService: function gotoService(value) {
      if (this.$auth.check()) {
        if (this.$auth.user().type === 2) this.$router.push('/services/stat/create');else this.$toast.warning(this.$t('Хизмат фақат юридик шахслар учун тақдим этилади'));
