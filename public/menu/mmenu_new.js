!function (e) {
    ...
    var u = {Menu: "Щ…Щ†Щ€"}, h = {Menu: "MenГј"}, v = {Menu: "РњРµРЅСЋ"};
    ...
    var we = {clear: !1, form: !1, input: !1, submit: !1},
        Ee = {Search: "Ш¬ШіШЄШ¬Щ€", "No results found.": "Щ†ШЄЫЊШ¬Щ‡вЂЊШ§ЫЊ ЫЊШ§ЩЃШЄ Щ†ШґШЇ.", cancel: "Ш§Щ†ШµШ±Ш§ЩЃ"},
        xe = {Search: "Suche", "No results found.": "Keine Ergebnisse gefunden.", cancel: "beenden"}, ke = {
            Search: "РќР°Р№С‚Рё",
